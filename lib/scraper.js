...
function createScraper(deps) {
	...
	var concurrentConnections = !normalizedFetchOptions['reqPerSec'] ? queue.length : (Math.floor(normalizedFetchOptions['reqPerSec']) || 1);
	var timeSpacing = !normalizedFetchOptions['reqPerSec'] ? 0 : 1000/normalizedFetchOptions['reqPerSec'];
